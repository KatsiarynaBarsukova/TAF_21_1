...
public class DivTest extends BaseTest {
    ...
    public void divIntTest() {
        Assert.assertEquals(calculator.div(10, 5), 2, "Wrong division...");
    }

    @Test(groups = "regression", priority = 2)
    public void divDoubleTest() {
        Assert.assertEquals(calculator.div(10.0, 5.0), 2.0, "Wrong division...");
    }
    ...
    public void divDoubleTest1() {
        Assert.assertEquals(calculator.div(10.0, 2.0), 5.0, "Wrong division...");
    }
    ...
    public void testDataProvider(int a, int b, int expectedResult) {
        Assert.assertEquals(calculator.div(a, b), expectedResult, "Wrong division...");
    }
    ...
    public void testExceptionsInt0by0(){
        Assert.assertEquals(calculator.div(0, 0), 0, "not possible");
    }
    @Test(groups = "smoke")
